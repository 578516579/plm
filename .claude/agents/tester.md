...
tester agent 在工作时调用 4 个专用子 skill (在 `.claude/skills/`):

| Skill | 何时调 | 输出 |
|---|---|---|
| [test-plan-writer](../skills/test-plan-writer/SKILL.md) | §2.1 测试计划 | `04-测试/<模块>-测试计划.md` (6 段 + 覆盖矩阵) |
| [test-case-designer](../skills/test-case-designer/SKILL.md) | §2.2 用例库 | `04-测试/测试用例库/<模块>/TC-NNN.md` (Given-When-Then × 6 类) |
| [quality-gate-audit](../skills/quality-gate-audit/SKILL.md) | §2.4 6 维质量门禁 | `04-测试/quality-gate-audit-<模块>-<date>.md` |
| [defect-triage](../skills/defect-triage/SKILL.md) | §2.5 缺陷生命周期 | plm-defect record + `04-测试/缺陷复盘/<DEF-NN>.md` |

工作流: tester agent 接到 task → 选 skill → skill 产输出 → tester 整合 → Phase 04 Gate 签字。
