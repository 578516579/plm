# Submission 模块 — 测试计划 (骨架,2026-05-17)

| 字段 | 值 |
|---|---|
| 版本 | v1.0-skeleton (派生于 commit b158d2f) |
| 关联 PRD | [Submission-PRD.md](../01-立项/Submission-PRD.md) |
| 关联 API 设计 | [Submission-API设计.md](../02-设计/Submission-API设计.md) |
| E2E spec | [plm-frontend/e2e/submission.spec.ts](../plm-frontend/e2e/submission.spec.ts) |
| 测试经理 | Wjl (solo) |

## 1. 测试范围
- 单元测试 (Service 层): mvn -pl plm-submission test
- E2E 测试 (前端 + 后端集成): npm run test:e2e -g "Submission"
