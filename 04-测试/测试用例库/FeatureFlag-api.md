# FeatureFlag 模块 — 接口用例 (骨架,2026-05-17)
...
| 关联 API 设计 | [../../02-设计/FeatureFlag-API设计.md](../../02-设计/FeatureFlag-API设计.md) |
| Base URL | `/business/feature-flag` |
| Controller | `plm-backend/plm-feature-flag/.../FeatureFlagController.java` |
...
按 PRD §5 / [API 设计](../../02-设计/FeatureFlag-API设计.md) §权限串前缀 `business:feature-flag:*`。
