# Testreport 模块 — E2E 自动化测试 (骨架,2026-05-17)

工具: [Playwright](https://playwright.dev/) (headless Chromium)。
脚本位置: [plm-frontend/e2e/testreport.spec.ts](../../plm-frontend/e2e/testreport.spec.ts)

| 字段 | 值 |
|---|---|
| 版本 | v1.0-skeleton (派生于 commit e682574) |
| 关联测试计划 | [../Testreport-测试计划-2026-05-17.md](../Testreport-测试计划-2026-05-17.md) |
| fixtures | `plm-frontend/e2e/helpers/fixtures.ts` 或 fixtures-testreport.ts |
| 状态机矩阵 | `plm-frontend/e2e/helpers/fixtures.ts` Testreport_STATUS_TRANSITIONS |
...
cd plm-frontend
export DB_PASSWORD=...
npm run test:e2e -g "Testreport"           # 跑本模块
npm run test:e2e                          # 全套
```
...
- 字典数据已 import (sys_dict_data biz_testreport_*)
