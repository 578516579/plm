...
-->
CLAIM | Claude (Wjl 会话, 2026-05-28) — openspec 字典 SSoT 抽取 (solo-review) | chore/local-start-backend-script | plm-frontend/src/views/business/openspec/index.vue;plm-frontend/src/views/business/openspec/openspecDict.ts | 2026-05-28
<!-- CLAIMS:END -->
