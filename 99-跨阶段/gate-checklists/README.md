...
| 你的场景 | 建议组合 | 必走 Gate（典型） |
|---|---|---|
| PLM 业务模块（如 Project/Phase/Task）在小团队推进 | `L1 / internal-tool / small or solo` | 01-06 全套，B.1 访谈 ≥ 2、商业计划用 ROI 模型 |
| 外部 SaaS 主要新功能 | `L1 / external-product / medium-large` | 01-06 全套，B.1 访谈 ≥ 5、商业计划含收入预测 |
| Spring Boot 大版本升级 | `L1 / framework-upgrade / 任意规模` | 02 强 ADR + 04 强回归 + 05 强回滚；01 仅简短"动机+影响面" |
| 已有功能 typo / 小 bug | `L3 / 任意类型 / 任意规模` | 仅 03 PR + 04 回归子集 |
