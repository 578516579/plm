...
| [0028](0028-product-mainline-uplift-epic.md) | 产品主线贯通迭代 epic — P0-1 跨模块外键(submission/defect/release/pipeline 4 列)+ P0-2 详情页跨模块跳转 + P0-3 TestReport/DORA 真聚合 + P0-4 AiButton 紫渐变组件 + P0-5 Dashboard 错态显形 | **P0-1 + P0-4 + P0-5 merged → tracking**(User-requested,solo-review;P0-2 + P0-3 仍 proposed)| 2026-05-28 | 2026-05-28 PM 验收会话:5 条主线 4 条断 + 6 模块 AI 按钮全军覆没;用户答 "需要" 同意进入 proposal | `3ae00fd`(⚠ commit msg `test(openspec)` 系并行 session race 误并入,实际含 0028 epic + 4 SQL + 4 模块 Java FK)+ `5c01814`(P0-4 AiButton 紫渐变 + 6 模块 9 处 + P0-5 dashboard 错态显形)| 2026-05-28 → 06-25 |
