...
| [0014](0014-zentao-bidirectional-sync.md) | 禅道(ZenTao)双向同步 — 修订 Proposal 0007 / 设计文档 §1.2 "先做单向" 取舍 | **merged → tracking** (User-requested-bypass) | 2026-05-25 | 用户明确请求 + 真实禅道环境可联调 | 待填 | 2026-05-25 → 06-30 |
...
| [0016](0016-business-sql-template-lint.md) | business-*.sql 模板 lint hook + sys_menu URL 改动前端硬编码扫描 | **draft** | 2026-05-25 | [reflect/2026-W22-modules-bulk-uplift](../reflect/2026-W22-modules-bulk-uplift.md) 模式 2 + 3 / A3+A4 | 待 merged | 待 merged → 2026-06-22 |
