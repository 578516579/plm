...
| [0028](0028-product-mainline-uplift-epic.md) | 产品主线贯通迭代 epic — P0-1 跨模块外键(submission/defect/release/pipeline 4 列)+ P0-2 详情页跨模块跳转 + P0-3 TestReport/DORA 真聚合 + P0-4 AiButton 紫渐变组件 + P0-5 Dashboard 错态显形 | **P0-1 + P0-2 + P0-4 + P0-5 merged → tracking**(User-requested,solo-review;仅 P0-3 剩,epic 进度 80%)| 2026-05-28 | 2026-05-28 PM 验收会话:5 条主线 4 条断 + 6 模块 AI 按钮全军覆没;用户答 "需要" 同意进入 proposal | `3ae00fd`(⚠ msg `test(openspec)` race 偷)+ `5c01814`(P0-4+P0-5)+ `21b7166`(P0-2A SPI 解 P0-1 known limit + P0-2B 2 endpoint)+ `656a6a4`(⚠ msg `docs(proposal): README 索引登记 0029` 第 2 次 race 偷 P0-2C 11 文件;同号 0029 README 行系并行 session 真正改动)| 2026-05-28 → 06-25 |
