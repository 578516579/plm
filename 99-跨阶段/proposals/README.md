...
| [0101](0101-mr-url-host-whitelist.md) | 业务 URL 字段 host 白名单校验（防钓鱼）| **merged → tracking** (规范层；代码实施 BL-2026-007/008) | 2026-05-17 | reflect W21 批次 / signals 0025 | apply 0101 (含 0041 dogfood drift 修正)（2026-05-17 `[solo-review]`）| 2026-05-17 → 05-31 |
| [0200](0200-encoding-pretooluse-hook.md) | 编码自检脚本接入 git pre-commit + Claude PreToolUse hook | **merged → tracking** (check-encoding.sh staged 优化 BL-2026-009) | 2026-05-17 | reflect W21 批次 / signals 0030（派生自 0028）| apply 0200 (3 文件落地 + 1 文件新建)（2026-05-17 `[solo-review]`）| 2026-05-17 → 05-31 |
| [0201](0201-hooks-self-evolution-flow-control.md) | Hooks 自进化流程控制扩展 (规范文件 PreToolUse warning + skill 触发 hint) | **merged → tracking** | 2026-05-19 | 用户指令 "增加 hook, 控制流程" / silent merge 反模式 (W19-W21 3 次) | apply 0201 same-day (.claude/settings.json 2 段 case 扩) 2026-05-19 `[solo-review]` | 2026-05-19 → 06-02 |
...
| [0041](0041-meta-rule-grep-existing-code.md) | 扩展 0040 §3.1 — 写规范类 proposal 前 grep 现存代码合规性 | **merged → tracking** | 2026-05-17 | [reflect/2026-W20-tracking-audit-mid](../reflect/2026-W20-tracking-audit-mid.md) F-AUDIT-F2 派生 | same-day 落地 0000-template.md §3 第 4 checkbox（2026-05-17 `[solo-review]`）| 2026-05-17 → 05-31 |
