...
| **🤝 Parallel session collaboration** | [99-跨阶段/协作规范.md](99-跨阶段/协作规范.md) + [99-跨阶段/在途任务.md](99-跨阶段/在途任务.md) | Multi-worktree / multi-session scenarios — worktree isolation, SSoT resource lock, task ledger, conflict handling. **Required reading** when running parallel Claude sessions. |
