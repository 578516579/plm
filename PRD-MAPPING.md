...
- 🟢 **PRD-aligned** (粗体,§2 字段表 + 代码 + mvn test 绿) = **20 个**: inception / **project** / **requirement** / competitive / prd / ued / arch / dbdesign / apidesign / testdata / autotest / manual-impl / manual-ops / analytics / dashboard / ai-agent / openspec / pipeline / feature-flag / dora
...
- ✅ requirement (完成): aiValue 字段 + ADR-A 4 态状态机决策 (commit `1afe0ba`→`df35652`→本 commit)
