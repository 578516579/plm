...
| F4.6 | 质量 | `defect` | `defects.html` | `tb_defect` | `DEFECT-YYYY-NNNN` (ADR-0005) | 🟡 字段表已提案 / 代码待对齐 (ADR-D) |
...
- 🟡 字段表已提案 / 代码待对齐 = **1 个**: defect (ADR-D Option A 实施中)
- 🟡 空壳 = **0 个**
- 🔴 空 = **0 个**
...
> **状态**: 提案中 — 实施 [proposal 0302 (ADR-D)](99-跨阶段/proposals/0302-adr-d-defect-state-machine.md) Option A 的字段表 + 状态机重设;代码 commit 落地后升级 🟢 **PRD-aligned**
