...
| F4.2 | 质量 | `testcase` | `testcase.html` | `tb_testcase` | `TC-YYYY-NNNN` (ADR-0006) | 🟡 字段表已提案 / 代码待对齐 (ADR-B) |
...
- 🟢 **PRD-aligned** (粗体,§2 字段表 + 代码 + 测试绿) = **28 个**: inception / **project** / **requirement** / competitive / prd / ued / arch / dbdesign / apidesign / **sprint** / **task** / **testplan** / **testreport** / testdata / autotest / **submission** / **manual-product** / manual-impl / manual-ops / **apidoc** / analytics / dashboard / ai-agent / openspec / pipeline / feature-flag / dora / **release**
- 🟢 早期对齐 (代码已跑通,§2 字段表待补,drift 审计 🟡 中等) = **2 个**: defect / document
- 🟡 字段表已提案 / 代码待对齐 = **1 个**: testcase (ADR-B / proposal 0300 Option B 已通过,代码 commit 跟进中)
- 🟡 空壳 = **0 个**
- 🔴 空 = **0 个**
...
> **状态**: 提案中 — 实施 [proposal 0300 (ADR-B)](99-跨阶段/proposals/0300-adr-b-testcase-category-dict.md) Option B 的字段表;代码 commit 落地后升级 🟢 **PRD-aligned**
