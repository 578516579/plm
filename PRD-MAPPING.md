...
**统计**:
- 🟢 已对齐 = **24 个** (含 inception + prd + competitive + ued + arch + dbdesign + apidesign + testdata + autotest + manual-impl + manual-ops)
- 🟡 空壳 = **7 个** (analytics/dashboard/ai-agent/openspec/pipeline/feature-flag/dora)
- 🔴 空 = **0 个**
...
plm-admin (entry)
  ...
  └── 业务模块 × 30
       ...
       │    apidoc, manual-product, manual-impl, manual-ops,
       │    inception, competitive, prd, ued, arch, dbdesign,
       │    apidesign, testdata, autotest
       └── (空壳 7,待 PRD-align)
