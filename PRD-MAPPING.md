...
**统计**:
- 🟢 已对齐 = **26 个** (含本批 analytics + dashboard,P0/P1/P2 闭环)
- 🟡 空壳 = **5 个** (ai-agent/openspec/pipeline/feature-flag/dora — P3 扩展)
- 🔴 空 = **0 个**
...
plm-admin (entry)
  ...
  └── 业务模块 × 30
       ...
       │    apidesign, testdata, autotest, analytics, dashboard
       └── (空壳 5,P3 扩展)
            ai-agent, openspec, pipeline, feature-flag, dora
```
