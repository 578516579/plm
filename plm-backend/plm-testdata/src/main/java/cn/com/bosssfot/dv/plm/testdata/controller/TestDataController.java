...
/** 测试数据工厂 Controller — PRD §F4.3 — /business/testdata/* */
@RestController
...
public class TestDataController extends BaseController {
    ...
    public void export(HttpServletResponse response, TestData testdata) {
        ...
        new ExcelUtil<TestData>(TestData.class).exportExcel(response, list, "测试数据集");
    }
