...
CREATE TABLE tb_prd (
    ...
    content             LONGTEXT                               COMMENT 'PRD 全文 Markdown (AI 生成 7 段)',
    completeness_score  DECIMAL(5,2)  DEFAULT NULL             COMMENT '完整度 0-100, §F2.2 验收 ≥80',
    ...
    status              VARCHAR(20)   NOT NULL DEFAULT '00'    COMMENT 'biz_prd_status',
