...
CREATE TABLE tb_testcase (
    ...
    category                 VARCHAR(20)   NOT NULL DEFAULT '01'    COMMENT 'biz_testcase_category',
    priority                 VARCHAR(20)   NOT NULL DEFAULT '01'    COMMENT 'biz_testcase_priority',
    status                   VARCHAR(20)   NOT NULL DEFAULT '00'    COMMENT 'biz_testcase_status',
